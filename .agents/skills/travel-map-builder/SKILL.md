...
5. Research and store address, hours/last order, price, admission, reservation status, menu, and `infoSourceUrl` when available. Keep uncertain facts visibly marked as `확인 필요`, never as confirmed.
