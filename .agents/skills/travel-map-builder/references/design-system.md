...
- 헤더 바로 아래에 `DAY 1`~`DAY 4` 날짜 탭을 둡니다. 선택된 날짜는 진한 잉크색 pill 카드로 강조합니다.
...
- 393~430px 모바일 화면에서 헤더·DAY 탭·sticky 지도·첫 카드·하단 내비가 서로 가리지 않습니다. 헤더 하단과 DAY 탭 상단은 0px, DAY 탭 하단과 지도 상단은 일정한 여백을 유지해야 합니다.
